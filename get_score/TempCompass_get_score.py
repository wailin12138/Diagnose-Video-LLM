...
def calculate_accuracy(jsonl_path):
    ...
    return stats, total_correct, total_entries

def print_results(stats, total_correct, total_entries, verbose=False):
    """打印统计结果"""
    if verbose:
        print("分类准确率统计：")
...
if __name__ == "__main__":
    ...
    # 计算准确率
    stats, total_correct, total_entries = calculate_accuracy(args.jsonl_path)
    
    # 打印结果
    print_results(stats, total_correct, total_entries, args.verbose)